...
export function AccreditationStatusModal({ onClose }: AccreditationStatusModalProps) {
	return (
		<div
		...
		>
			<div className="bg-white max-w-4xl h-max w-full grid grid-cols-1 md:grid-cols-2 gap-7 rounded-xl shadow-large p-8 sm:mt-32 mx-8">
				...
				<div className="space-y-7">
					<div>
						<p className="label-large-medium text-neutral-500">You&apos;re almost there</p>
					...
					<p className="body-small-regular text-neutral-500">
						Federal law requires that we verify you are an accredited investor before providing you
						with investment opportunities in private companies.
					</p>
					...
					<Button label="Continue" onClick={onClose} rightIcon={<HiArrowRight />} />
				</div>
			</div>
		</div>
	);
