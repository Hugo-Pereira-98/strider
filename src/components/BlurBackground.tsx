	...
	return (
		<div
			className={classNames(
				{ 'hidden': hideBlur },
				lightBlur ? 'bg-white/10 dark:bg-gray-dark-950/10' : 'bg-white/40 dark:bg-gray-dark-950/40',
				margin,
		...
		>
			<div className="max-w-[352px] mx-auto text-center">
				...
				<div className="mt-4 mb-6">
					<p className="body-medium-semibold text-gray-light-950 dark:text-gray-dark-50">{title}</p>
