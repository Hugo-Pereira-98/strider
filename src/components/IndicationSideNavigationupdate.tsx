...
export default function IndicationSideNavigationUpdate() {
      ...
      <div className="bg-gray-light-50 dark:bg-gray-dark-900 min-w-[320px] w-[440px] md:flex flex-col sticky bottom-0 top-0 h-screen hidden">
        ...
        <div className="mt-8 md:-mt-12 px-6 lg:px-8 flex-1">
          ...
          <SideItem
            ...
            icon={Sliders}
            isCurrentItem={asPath.includes(
              `/indication/update/${formType}/terms`
            )}
          />
          ...
          <SideItem
            ...
            icon={Cube}
            isCurrentItem={asPath.includes(
              `/indication/update/${formType}/structure`
            )}
          />
          ...
          <SideItem
            ...
            icon={CheckCircle}
            isCurrentItem={asPath.includes(
              `/indication/update/${formType}/review`
            )}
            border={false}
          />
        </div>
