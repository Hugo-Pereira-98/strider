...
export function CompanyTable({
  ...
  const { data: watchlistedData, loading: watchlistLoading } = useQuery(
        ...
        <>
          ...
          <div className="flex items-center justify-between px-6 pb-4 pt-3 border-t border-gray-light-200 dark:border-gray-dark-800">
            ...
            <Pagination
              ...
              totalItems={formattedOrganizations?.length || 0}
              onPageChange={handlePageChange}
            />

            <div className="body-small-regular md:hidden">
              Page {currentPage} of {formattedOrganizations?.length}
            </div>
            ...
            <div>
              <Button
                ...
                disabled={
                  currentPage ===
                  Math.ceil(
                    (formattedOrganizations?.length || 0) / itemsPerPage
                  )
                }
              />
              <Button
